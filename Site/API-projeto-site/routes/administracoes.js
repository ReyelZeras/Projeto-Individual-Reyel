...
var administracao = require('../models').administracao;
...
router.post('/autenticar', function(req, res, next) {
	...
	let instrucaoSql = `select * from administracao where email='${email}' and senha='${senha}'`;
...
router.get('/', function(req, res, next) {
	...
	administracao.findAndCountAll().then(resultado => {
